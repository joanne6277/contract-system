...
export const businessFieldConfig: { [key: string]: BusinessFormFieldConfig[] } = {
    'basic-info': [
        ...
        { id: 'clientName', label: '採購單位', type: 'text' },
        { id: 'purchasingYear', label: '採購年份', type: 'text', placeholder: '例: 2024' },
    ],
    'purchase-content': [
        { id: 'mode', label: '模式', type: 'select', options: ['模式A', '模式B'] },
        { id: 'contractStartDate', label: '履約起始日', type: 'date' },
        { id: 'contractEndDate', label: '履約結束日', type: 'date' },
        { id: 'attribute', label: '屬性', type: 'select', options: ['屬性1', '屬性2'] },
        { id: 'productName', label: '採購產品項目', type: 'tags', placeholder: '輸入產品後按 Enter...', fullWidth: true },
