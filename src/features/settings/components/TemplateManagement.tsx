...
export const TemplateManagement: React.FC = () => {
    ...
    const [templates, setTemplates] = useState<Template[]>([
        { id: 't-1', name: '標準授權合約範本', version: '2.1', lastModified: '2024-07-15', file: '標準授權合約範本_v2.1.docx', status: 'current' },
        { id: 't-2', name: '獨家代理合約範本', version: '1.5', lastModified: '2024-06-30', file: '獨家代理合約範本_v1.5.docx', status: 'current' },
        { id: 't-3', name: '保密協議(NDA)', version: '3.0', lastModified: '2024-08-01', file: '保密協議(NDA)_v3.0.pdf', status: 'current' },
        { id: 't-4', name: '舊版授權合約', version: '1.0', lastModified: '2022-01-20', file: '舊版授權合約_v1.0.docx', status: 'past' },
    ]);
    ...
    return (
        <div className="bg-white rounded-xl shadow-lg p-8 relative">
            <div className="flex justify-between items-center mb-6">
                <div><h2 className="text-2xl font-bold text-gray-800">範本管理</h2><p className="text-gray-600 mt-1">集中管理與下載合約範本。</p></div>
                {currentUser?.permissions.maintainTemplate && (
            ...
            >
                <div className="space-y-6">
                    <div><label className="block text-sm font-medium text-gray-700 mb-2">範本名稱</label><input type="text" value={newTemplate.name} onChange={e => setNewTemplate(prev => ({ ...prev, name: e.target.value }))} className="w-full px-4 py-2 border border-gray-300 rounded-lg" placeholder="例如：標準授權合約" /></div>
                    <div><label className="block text-sm font-medium text-gray-700 mb-2">版本號</label><input type="text" value={newTemplate.version} onChange={e => setNewTemplate(prev => ({ ...prev, version: e.target.value }))} className="w-full px-4 py-2 border border-gray-300 rounded-lg" placeholder="例如：v2.0" /></div>
